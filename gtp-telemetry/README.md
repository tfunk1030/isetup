...
The app reads local `.ibt` files in the browser, parses session header and telemetry channels client-side, runs setup/performance analysis, and renders chart-heavy dashboards with optional PDF export.
